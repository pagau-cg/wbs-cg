...
function blobName(userId, projectId) {
  return `users/${userId}/projects/${(projectId||"projet").replace(/[^a-zA-Z0-9_-]/g,"_").slice(0,64)}.json`;
}
...
module.exports = { getContainer, getUserId, blobName, metaBlob, revisionBlob, safeDossier, safeRev };
